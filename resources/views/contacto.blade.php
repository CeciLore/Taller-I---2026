    ...
    <section id="contacto" class="contact-section">
            ...
            <div class="row align-items-start mt-lg-5">
                ...
                <div class="col-lg-7">
                    <form action="{{ url('/contacto') }}" method="POST" id="formContacto"
                        class="contact-form p-4 p-md-5 bg-white shadow-lg needs-validation" novalidate>
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nombre" class="form-control contact-input border-2 shadow-none"
                                placeholder="Ingresa tu nombre y apellido" required minlength="5"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control contact-input border-2 shadow-none"
                                placeholder="tu-email@correo.com" required>
                            <div class="invalid-feedback fw-bold">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="telefono" class="form-control contact-input border-2 shadow-none"
                                placeholder="Ej: 3794000000" required>
                            <div class="invalid-feedback fw-bold">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="area" class="form-select contact-input border-2 shadow-none" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="mensaje" class="form-control contact-textarea border-2 shadow-none" rows="4"
                        ...
                        <div id="mensajeExito" class="success-message mt-4 text-center d-none">
        ...
        <div class="container mt-5">
            ...
            <div class="map-container">
                <iframe src="https://www.google.com/maps?q=Corrientes+Capital,+Argentina&output=embed" width="100%"
