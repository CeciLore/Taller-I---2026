...
<section id="contacto" style="background: var(--brand-purple); padding: 160px 5% 80px 5%; position: relative; z-index: 10;">
    
    <div class="container mt-5 pt-5">
        <div class="row align-items-start mt-lg-5"> 
            
            <div class="col-lg-5 text-white mb-5 mb-lg-0">
                <h1 class="display-3 mb-4 fw-bold" style="text-shadow: 4px 4px 0px var(--brand-pink); line-height: 1;">
                    CONTACTO
                </h1>

                <p class="lead fw-bold mb-4" style="font-size: 1.5rem;">
            ...
            <div class="col-lg-7">
                <form action="{{ url('/contacto') }}" method="POST" id="formContacto"
                      class="contact-form p-4 p-md-5 bg-white shadow-lg needs-validation"
                      novalidate
                      style="border-radius: 30px; border: 4px solid #000; box-shadow: 15px 15px 0px #000 !important;">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="invalid-feedback fw-bold">
                            El nombre debe tener al menos 5 caracteres y solo letras.
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               style="border-color: #000; height: 50px;">
                        <div class="invalid-feedback fw-bold">
                            El teléfono debe contener solo números (mínimo 7).
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="invalid-feedback fw-bold">
                            Selecciona un área de contacto.
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="mensaje"
                                  ...
                                  required
                                  pattern=".*\S.*"
                                  style="border-color: #000;"></textarea>
                        <div class="invalid-feedback fw-bold">
                    ...
                    <button type="submit" id="btnEnviar"
                            class="btn btn-warning btn-lg w-100 py-3 mt-3 fw-bold shadow-none"
                            style="border: 4px solid #000; transition: 0.3s; font-size: 1.2rem;">
                        ENVIAR
                    </button>

                    <div id="mensajeExito"
                         class="mt-4 text-center d-none"
                         style="background: #2ecc71; color: white; padding: 20px; border-radius: 20px; border: 3px solid #000; box-shadow: 5px 5px 0px #000;">
    ...
    <div class="container mt-5">
        <h3 class="text-white mb-3 fw-bold">Nuestra ubicación</h3>

        <div style="border-radius: 20px; overflow: hidden; border: 4px solid #000;">
            <iframe 
